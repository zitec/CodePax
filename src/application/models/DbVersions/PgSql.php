 ...
 * */
class CodePax_DbVersions_PgSql extends CodePax_Sql implements CodePax_DbVersions_Interface {
	...
	public function getLatestVersion($_script_type) {
		$query = $this->db->prepare('SELECT (
			CAST(major AS text) ||  \'.\'  || 
			CAST(minor AS text) || \'.\' || 
			CAST(point AS text)) AS version, date_added
