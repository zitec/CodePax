 ...
 * */
define('APPLICATION_ENVIRONMENT', 'prod');

/**
 * Shows/hides switch to branch option
 * */
define('SWITCH_TO_BRANCH', false);
 ...
 * */
define('SWITCH_TO_REVISION', false);

/**
 * Shows/hides switch to trunk button
 * */
define('SWITCH_TO_TRUNK', false);
 ...
 * */
define('REPO_URL', 'ssh://git@git.zitec.ro:6246/marius.udubasa/Regista.git');
